...
export function CoursePlayerLayout({ course }: { course: AcademyCourse }) {
  return (
    <div className="grid gap-6 lg:grid-cols-[340px_minmax(0,1fr)] xl:grid-cols-[360px_minmax(0,1fr)]">
      <aside className="order-2 lg:sticky lg:top-24 lg:order-1 lg:h-[calc(100vh-6rem)] lg:overflow-y-auto lg:pr-2">
        <div className="space-y-5 rounded-2xl border border-emerald-100 bg-white/75 p-4 shadow-sm lg:bg-white">
          <div className="rounded-2xl bg-emerald-950 p-5 text-white">
            ...
            <h2 className="mt-2 text-lg font-bold leading-6">{course.title}</h2>
          </div>
