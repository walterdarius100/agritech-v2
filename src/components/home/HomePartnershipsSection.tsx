          ...
          {carouselItems.map((partnership, index) => {
            ...
            return (
              <article
                ...
                className="group relative h-[200px] w-[78vw] max-w-[300px] shrink-0 overflow-hidden rounded-xl bg-emerald-950 shadow-md ring-1 ring-emerald-900/10 sm:h-[205px] sm:w-[300px] md:w-[310px] lg:h-[215px] lg:w-[330px]"
              >
                <Image
                ...
                <div className="absolute inset-x-0 bottom-0 z-10 p-3 sm:p-3.5">
                  ...
                  <p className="mt-2 max-w-[16rem] text-[0.82rem] font-semibold leading-relaxed text-white drop-shadow-sm sm:text-sm">
                    {partnership.title}
                  </p>
                </div>
              </article>
