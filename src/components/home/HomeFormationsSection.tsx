...
export function HomeFormationsSection() {
  return (
    <Section className="bg-white">
      <div className="overflow-hidden rounded-2xl bg-emerald-950 shadow-2xl shadow-emerald-950/15 ring-1 ring-emerald-900/10">
        <div className="grid min-h-[560px] lg:grid-cols-2">
          ...
          <div className="flex items-center bg-emerald-950 px-6 py-10 sm:px-10 sm:py-14 lg:px-14 xl:px-16">
