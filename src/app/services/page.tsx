...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "Découvrez les services agricoles d’Agri-tech : aviculture, cuniculture, apiculture, pisciculture, production végétale, irrigation, formation et étude de projets agricoles.",
  path: "/services",
});
      ...
      <Section className="bg-[#f8faf7] pt-0">
        ...
        <div className="mt-12 rounded-2xl border border-emerald-100 bg-white p-8 text-center shadow-sm">
          <h2 className="text-2xl font-bold text-emerald-950">
            {messages.services.helpTitle}
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-slate-600">
            {messages.services.helpDescription}
          </p>
          <Button href={contactHref} className="mt-6">
            {messages.services.helpAction}
          </Button>
        </div>
      </Section>
    </>
