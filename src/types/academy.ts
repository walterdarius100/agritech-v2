...
export type EnrollmentStatus =
  "pending" | "active" | "rejected" | "expired" | "completed";
export type EnrollmentSource = "manual" | "payment" | "free" | "admin_grant";
export type CertificateStatus =
  "issued" | "valid" | "draft" | "revoked" | "expired";
...
export type AcademyResource = {
  ...
  resource_type: "document" | "pdf" | "video" | "link" | "image" | "other";
...
export type AcademyEnrollment = {
  ...
  access_source: EnrollmentSource;
  ...
  created_at: string;
  updated_at: string;
  academy_courses?: AcademyCourse | null;
...
export type AcademyPrototypeCourse = {
  title: string;
  slug: string;
  category: string;
