...
export type AcademyCertificate = { id: string; certificate_id: string; student_id: string; course_id: string; student_full_name: string; course_title: string; issued_at: string; status: CertificateStatus; verification_url: string | null; pdf_url: string | null; qr_code_url: string | null; created_at: string; updated_at: string; academy_courses?: AcademyCourse | null; profiles?: Profile | null; };
