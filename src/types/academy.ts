...
export type CertificateStatus = "issued" | "valid" | "draft" | "revoked" | "expired";
...
export type AcademyCertificate = { id: string; certificate_id: string; student_id: string; course_id: string; enrollment_id: string | null; student_full_name: string; course_title: string; issued_at: string; status: CertificateStatus; verification_url: string | null; pdf_url: string | null; qr_code_url: string | null; certificate_email_sent_at?: string | null; metadata: Record<string, unknown>; created_at: string; updated_at: string; academy_courses?: AcademyCourse | null; profiles?: Profile | null; };
export type Profile = { id: string; full_name: string | null; phone: string | null; organization: string | null; role: "student" | "admin"; created_at: string; updated_at: string; welcome_email_sent_at?: string | null; };
